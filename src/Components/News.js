...
export class News extends Component {
    ...
    async updateNews(){
      ...
      let url = `https://newsapi.org/v2/top-headlines?country=${this.props.country}&category=${this.props.category}&apiKey=562c56fbc34c4811b1aa9f37e770dac8&page=1&pageSize=${this.props.pageSize}`;
    ...
    render() {
         return (
         <>
          <h1 className="text-center" style={{margin: '35px 0px', marginTop:'90px'}}>NewsMonkey - Top 
